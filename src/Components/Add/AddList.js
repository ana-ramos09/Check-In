    ...
    return <div className='new-list-container'>
                ...
                <div className='create-list-container'>
                    <div className='new-list'>
                        <input className='new-list-name' onChange={inputNameHandler} placeholder='Name'></input>
                        <input className='new-list-location' onChange={inputLocationHandler} placeholder='City'></input>
                    </div>
